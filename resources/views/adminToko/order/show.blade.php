		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-body">
					...
					Kode Pos : {{ $order->kode_pos }}
					@endif
					
					<div class="email"><a href="https://api.whatsapp.com/send?phone=62{{ $order->nohp }}&amp;text=Halo.." target="_blank"><img src="https://static.whatsapp.net/rsrc.php/v3/y7/r/DSxOAUB0raA.png" style="width:10%"></a> </div> <br>
					</div>
					...
					<form method="post" action="{{ route('orderan.update',$order->id_order) }}">
						...
						<button type="submit" class="btn btn-sm btn-success" style="width:100%">Konfirmasi</button>
					</form>
					@else
