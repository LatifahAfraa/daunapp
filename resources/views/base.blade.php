        ...
        <nav class="navbar header">
            <a class="navbar-brand" href="{{ route('index') }}">
                @if (empty($toko->logo_toko))
                    <img src="https://via.placeholder.com/30x30.png?text={{ substr($toko->nm_toko, 0, 3) }}"
                        width="120" alt="">
                @else
            ...
            @guest
            @else
                <a href="{{ route('keranjang.index') }}" class="float-right"><i class="fa fa-shopping-cart"></i>
                    {{ $duitKeranjang }}</a>
            @endguest
        </nav>
    </header>
    ...
    <footer>
        <div class="container">
            <ul class="nav nav-justified">
                <li class="nav-item"><a class="nav-link" href="{{ route('index') }}"><i class="fa fa-home"
                            style="font-size: 18px;"></i><br>Home</a></li>
                <!--<li class="nav-item"><a class="nav-link" href="{{ route('ktg.index') }}"><i class="fa fa-th-large" style="font-size: 18px;"></i><br>Kategori</a></li>-->
                <li class="nav-item"><a class="nav-link" href="{{ route('order.index') }}"><i
                            class="fa fa-calendar-check" style="font-size: 18px;"></i><br>Pesanan</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('member.index') }}"><i class="fa fa-user"
                            style="font-size: 18px;"></i><br>Akun</a></li>
            </ul>
        </div>
    </footer>
